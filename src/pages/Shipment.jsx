                    ...
                    <div className="ml-5 space-y-6 pr-5 mt-5 mb-28">
                        <div className="relative gap-10">
                            <div className="input-with-icon">
                                ...
                                <input type="text" name="name" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-10 focus:outline-none" placeholder="Enter your name" onChange={this.handleInputChange} value={this.state.name} />
                            </div>
                        </div>
                        <div className="relative">
                            <div className="input-with-icon">
                                ...
                                <input type="text" name="mobile" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-10 focus:outline-none" placeholder="Enter your mobile number" onChange={this.handleInputChange} value={this.state.mobile} maxLength="10" />
                            </div>
                        </div>
                        <div className="relative">
                            <div className="input-with-icon">
                                ...
                                <input type="text" name="location" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-10 focus:outline-none" placeholder="Enter the details" onChange={this.handleInputChange} value={this.state.location} />
                            </div>
                        </div>
                        <div className="relative">
                            <div className="input-with-icon">
                                ...
                                <input type="text" name="area" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-10 focus:outline-none" placeholder="Enter the details" onChange={this.handleInputChange} value={this.state.area} />
                            </div>
                        </div>
                        <div className="relative">
                            <div className="input-with-icon">
                                <div className="absolute left-0 p-2 pointer-events-none font-semibold text-black ml-1 text-[17px]">Pincode</div>
                                <input type="text" name="pincode" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-3 focus:outline-none text-left" placeholder="Enter your pincode" onChange={this.handleInputChange} value={this.state.pincode} maxLength="6" />
                            </div>
                        </div>
                        <div className="flex gap-5">
                            <div className="relative">
                                <div className="input-with-icon">
                                    ...
                                    <input type="text" name="city" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-3 focus:outline-none" placeholder="" onChange={this.handleInputChange} value={this.state.city} />
                                </div>
                            </div>
                            <div className="relative">
                                <div className="input-with-icon">
                                    <div className="absolute left-0 p-2 pointer-events-none font-semibold text-black ml-1 text-[17px]">State</div>
                                    <input type="text" name="state" className="border w-full pt-9 p-1 py-5 border-dotted border-[#848484] text-black rounded-xl px-20 pl-3 focus:outline-none" placeholder="" onChange={this.handleInputChange} value={this.state.state} />
                                </div>
                            </div>
                        </div>
                        <div className="fixed bottom-4 left-0 right-0 flex justify-center items-center">
                            <Link to="/verification" className="flex bg-[#2D332F] rounded-full text-xl p-4 w-72 md:hidden text-white justify-center items-center">
                                Proceed
                            </Link>
                        </div>
                    </div>
