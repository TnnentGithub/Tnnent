                ...
                <section className="md:hidden">
                    <div className="w-full h-64" style={{ backgroundImage: `url(${bigIllustration})`, backgroundSize: 'cover', padding: '20px' }}>
                        ...
                        <div className="ml-[-370px] mt-[-50px] h-72 relative" style={{ backgroundImage: `url(${smallIllustration})`, backgroundSize: 'cover', backgroundPosition: 'left' }}>
                            <div className="flex flex-col items-center space-y-4 mt-20 justify-center ml-96">
                                <div className="relative">
                                    {this.state.dateLabelVisible && <span id="date-label" className="absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500">Enter date:</span>}
                                    <input id="date-input" type="date" placeholder="DD/MM/YYYY" className="border rounded-md py-2 px-2 focus:outline-none" onChange={this.hideLabel} />
                                </div>
                                <div className="relative">
                        ...
                        <div className="fixed bottom-4 left-0 right-0 flex justify-center items-center">
                            <Link href="chief_page.html" className="flex bg-[#2D332F] rounded-full text-xl p-4 w-72 md:hidden text-white justify-center items-center">
